...
from cube_budget.core.models import OptimizationObjective, SolverType
...
def optimize(
    ...
    objective: Optional[OptimizationObjective] = typer.Option(
        None,
        "--objective",
        help="Optimization objective: stores (min stores) or price (min total price)",
    ),
